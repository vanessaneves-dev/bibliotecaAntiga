          ...
          <Accordion defaultActiveKey="0">
            <Accordion.Item eventKey="0">
              ...
              <Accordion.Body  className={temaEscuro ? "bg-dark text-light" : "bg-white text-dark"}>
                ...
                coletando e como será usado. Apenas retemos as informações
          ...
          <Accordion defaultActiveKey="0">
            <Accordion.Item eventKey="0">
              ...
              <Accordion.Body  className={temaEscuro ? "bg-dark text-light" : "bg-white text-dark"}>
                ...
                anúncio é exibido para você. Para mais informações sobre o
                Google AdSense, consulte as FAQs oficiais sobre privacidade do
                Google AdSense. Utilizamos anúncios para compensar os custos de
                funcionamento deste site e fornecer financiamento para futuros
                ...
                semelhantes que possam ser do seu interesse. Vários parceiros
                ...
                site através de um dos sites de nossos parceiros, para que
                possamos creditá-los adequadamente e, quando aplicável, permitir
                que nossos parceiros afiliados ofereçam qualquer promoção que
              ...
              <Accordion.Body  className={temaEscuro ? "bg-dark text-light" : "bg-white text-dark"}>
                ...
                <li>
                  <strong>
                    ...
                    xenofóbica, betano ou azar, qualquer tipo de pornografia
                ...
                <li>
                  <strong>
                    ...
                    lógicos (softwares) do Bibliotech, de seus fornecedores ou
                ...
                Mais informações Esperemos que esteja esclarecido e, como
